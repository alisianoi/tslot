...
class TColorAwarePushButton(QPushButton):
...
class TPrimaryColorAwarePushButton(TColorAwarePushButton):
...
class TAlternateColorAwarePushButton(TColorAwarePushButton):
...
class TSuccessColorAwarePushButton(TAlternateColorAwarePushButton):

    pass


class TFailureColorAwarePushButton(TColorAwarePushButton):
